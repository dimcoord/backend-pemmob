<?php
	...
	$query = "UPDATE simpanan SET anggota_id = '".$anggota_id."', tgl_transaksi = '".$tgl_transaksi."', jenis = '".$jenis_simpanan."', jumlah = '".$jumlah_simpanan."', bulan_iuran = '".$bulan_iuran."', tahun_iuran = '".$tahun_iuran."' WHERE id = '".$id."'";
